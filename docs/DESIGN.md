...
Functions: 
    ...
    * `readKrag` - reads the krag file and build a data structure that stores each krag with its clue. Then, the function returns the data structure to the caller. 
