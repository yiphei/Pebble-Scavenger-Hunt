 ...
 *inserts new (key,item) pairs. The caller can retrieve items by asking for their 
 *key, but cannot remove or update pairs. Items are distinguished by their key. 
 *
 * Yifei Yan
 */
